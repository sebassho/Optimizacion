"""
interfaz.py - Interfaz grafica para Teoria de Grafos - Practica N 03
Universidad de Los Llanos | Ingenieria de Sistemas | Optimizacion
"""
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Teoria de Grafos - Practica N 03")
    ...
    def _header(self):
        ...
        h.pack(fill="x")
        tk.Label(h, text="Teoria de Grafos - Practica N 03",
